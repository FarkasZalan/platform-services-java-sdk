...
/**
 * Unit test class for the Acknowledgment model.
 */
public class AcknowledgmentTest {
  ...
  public void testAcknowledgment() throws Throwable {
    Acknowledgment acknowledgmentModel = new Acknowledgment();
    assertNull(acknowledgmentModel.isHasUnread());
    assertNull(acknowledgmentModel.getLatestNotificationId());
    assertNull(acknowledgmentModel.getLastAcknowledgedId());
  }
}