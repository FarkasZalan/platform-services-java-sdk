...
/**
 * Unit test class for the GetAcknowledgmentOptions model.
 */
public class GetAcknowledgmentOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetAcknowledgmentOptions() throws Throwable {
    GetAcknowledgmentOptions getAcknowledgmentOptionsModel = new GetAcknowledgmentOptions.Builder()
      ...
      .build();
    assertEquals(getAcknowledgmentOptionsModel.accountId(), "1369339417d906e5620b8d861d40cfd7");
  }
}