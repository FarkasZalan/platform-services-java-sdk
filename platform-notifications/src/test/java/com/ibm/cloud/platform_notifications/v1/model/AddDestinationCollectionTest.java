...
/**
 * Unit test class for the AddDestinationCollection model.
 */
public class AddDestinationCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testAddDestinationCollection() throws Throwable {
    AddDestinationCollection addDestinationCollectionModel = new AddDestinationCollection();
    assertNull(addDestinationCollectionModel.getDestinations());
  }
}