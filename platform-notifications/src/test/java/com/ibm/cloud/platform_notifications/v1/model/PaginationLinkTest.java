...
/**
 * Unit test class for the PaginationLink model.
 */
public class PaginationLinkTest {
  ...
  @Test
  public void testPaginationLink() throws Throwable {
    PaginationLink paginationLinkModel = new PaginationLink();
    assertNull(paginationLinkModel.getHref());
  }
}